...
#define CONFIG_KERNEL_LOAD_ADDR (SDRAM_BASE + (72 * 1024 * 1024)) // 0x40000000 + 0x4800000 = 0x44800000
#define CONFIG_DTB_LOAD_ADDR	(SDRAM_BASE + (64 * 1024 * 1024)) // 0x40000000 + 0x4000000 = 0x44000000
